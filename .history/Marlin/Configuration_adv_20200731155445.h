 ...
 */
#define E0_AUTO_FAN_PIN -1 //P2_03
#define E1_AUTO_FAN_PIN -1 //P2_03
...
//#define HOMING_BACKOFF_MM { 3, 3, 4 }  // (mm) Move away from the endstops after homing
...
//#define DIGIPOT_MOTOR_CURRENT { 135,135,135,180,180 }   // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
 ...
 */
#if HAS_TRINAMIC_CONFIG //Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
 ...
 */
// Purge & Wipe Macro M108 S255 | G28 | G1 Y50 Z0.3 F9600 | G1 X215 Z10 | G1 Z0.4 | G92 E0 | G1 E25 F225 | G92 E0 | G1 X200 Z0.1 E1.0 F1200 | G1 X195 Z0.25
//#define GCODE_MACROS
